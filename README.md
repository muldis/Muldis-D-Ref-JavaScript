...
This distribution features the JavaScript library named
```muldis-d-ref\_eng``` and its support structure.

muldis-d-ref\_eng is the reference implementation over JavaScript of the
**Muldis D** language by the authority Muldis Data Systems
